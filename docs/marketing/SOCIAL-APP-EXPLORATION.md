...
Wedding photos are emotional, beautiful, and high-stakes. People care deeply about them. This isn't food photos or gym selfies — it's once-in-a-lifetime moments. That emotional intensity drives:
...
- Higher quality content (even phone photos at weddings look good — the subjects are dressed up, the venues are decorated, the lighting is intentional)
...
|---------|-------------|
| Reactions & comments (Layer 1) | Free — drives engagement and retention |
| Guest accounts (Layer 2) | Free — grows the user base for future monetisation |
| Memory notifications (Layer 2) | Free, but include "Create your own event" CTA — conversion channel |
| Native app (Layer 3) | Free to download — monetisation stays on event creation |
| One-tap reshare (Layer 3) | Free — organic marketing (watermark visible in reshare) |
| Public feed (Layer 4) | Free to browse — drives top-of-funnel. Potential for promoted listings (venues, photographers pay to be featured) |
| Photographer portfolio (Layer 4) | Freemium — basic listing free, premium features (analytics, lead gen, featured placement) for a monthly fee |
...
## The Reshare Angle — Watermarks as Viral Branding
...
- The watermark says "Emma & Liam — June 14, 2026"
...
- 150 guests × 10% × 400 followers = **6,000 impressions per wedding**
- 200 weddings/month × 6,000 = **1.2 million impressions/month**
...
|------|---------------|---------------------|-------|
| **Afterglow** | Yes | Yes — "Open Afterglow to relive the night" | Strong for both. The afterglow is the social moment — revisiting, reacting, remembering. |
| **Confetti** | Yes | Yes — "Your Confetti feed" / "Confetti memories" | Playful, social-friendly. |
| **Toast** | Yes | Moderate — "Toast" as an app name might confuse with Toast POS | The verb works socially ("Toast this moment") but the naming conflict gets worse at app scale. |
| **Heirloom** | Yes | Less natural — "Your Heirloom feed" feels heavy | Better as a tool than a social platform. Too premium/quiet for social energy. |
| **Mosaic** | Yes | Yes — "Your Mosaic" / "See the full Mosaic" | Works metaphorically for a social feed (many pieces, one picture). |
