# Alignment System README

This folder contains the alignment operating system used to keep strategy execution focused, measurable, and synchronized.
...
1. close path-defining decisions,
2. choose one primary path,
3. run weekly execution discipline,
4. detect drift early,
5. recover quickly when alignment breaks.

---

## Quick Start

1. Read `ALIGNMENT-START-HERE.md`
...
- Diagnose: `MARKETING-DOCS-REVIEW.md`
- Decide: `ALIGNMENT-PRIORITY0-DECISION-BRIEF.md` + `ALIGNMENT-DECISIONS-LOG.md`
- Plan: `ALIGNMENT-DECISION-CALENDAR.md` + `PATH-ALIGNMENT-WORKSHEET.md`
...
- Reset quarterly: `ALIGNMENT-QUARTER-RESET-PROTOCOL.md`
...
For full routing by scenario, use:
...
- Keep decisions and docs synced within 48 hours.
